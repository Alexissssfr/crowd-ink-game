...
export const challenges = [
  checkpointChallenge, // Ajouter le challenge avec zone de passage en premier
  {
    ...
    checkpointZone: { x: 600, y: 520, w: 120, h: 60 }, // Zone de passage orange au milieu
...

  {
    ...
    targetTime: 60,
    spawn: { x: 120, y: 560 },
    checkpointZone: { x: 620, y: 420, w: 120, h: 40 }, // Zone de passage orange sur la 2ème marche
...

  {
    ...
    targetTime: 75,
    spawn: { x: 140, y: 540 },
    checkpointZone: { x: 600, y: 520, w: 120, h: 60 }, // Zone de passage orange sur le pilier central
...

  {
    ...
    targetTime: 50,
    spawn: { x: 160, y: 120 },
    checkpointZone: { x: 680, y: 420, w: 120, h: 40 }, // Zone de passage orange sur la plateforme intermédiaire
...

  {
    ...
    targetTime: 65,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 720, y: 520, w: 120, h: 60 }, // Zone de passage orange au milieu
    ...
    build(physics, width, height) {
      ...
      for (let i = 0; i < 8; i++) {
        ...
        pillars.push(
          Bodies.rectangle(x, 600 - height / 2, 24, height, {
            isStatic: true,
            render: { fillStyle: "#546e7a" },
          })
        );
...

  {
    ...
    targetTime: 80,
    spawn: { x: 140, y: 520 },
    checkpointZone: { x: 600, y: 430, w: 120, h: 40 }, // Zone de passage orange sur la plateforme mobile
...

  {
    ...
    targetTime: 55,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 700, y: 520, w: 120, h: 60 }, // Zone de passage orange au milieu du tunnel
...

  {
    ...
    targetTime: 70,
    spawn: { x: 140, y: 560 },
    checkpointZone: { x: 650, y: 380, w: 120, h: 40 }, // Zone de passage orange sur la rampe
...

  {
    ...
    targetTime: 90,
    spawn: { x: 140, y: 480 },
    checkpointZone: { x: 700, y: 350, w: 120, h: 40 }, // Zone de passage orange sur une île intermédiaire
...

  {
    ...
    targetTime: 100,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 800, y: 360, w: 120, h: 40 }, // Zone de passage orange au milieu du labyrinthe
...

  {
    ...
    targetTime: 85,
    spawn: { x: 120, y: 480 },
    checkpointZone: { x: 620, y: 480, w: 120, h: 60 }, // Zone de passage orange au milieu du pont
...

  {
    ...
    targetTime: 95,
    spawn: { x: 140, y: 560 },
    checkpointZone: { x: 600, y: 300, w: 120, h: 40 }, // Zone de passage orange au milieu de la spirale
...

  {
    ...
    targetTime: 75,
    spawn: { x: 160, y: 120 },
    checkpointZone: { x: 680, y: 400, w: 120, h: 40 }, // Zone de passage orange sur une plateforme intermédiaire
    goal: { x: 980, y: 560, w: 140, h: 40 },
    walkDirection: 1,
    build(physics, width, height) {
...

  {
    ...
    targetTime: 110,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 700, y: 520, w: 120, h: 60 }, // Zone de passage orange au milieu du labyrinthe
    goal: { x: 1040, y: 540, w: 120, h: 60 },
    walkDirection: 1,
    build(physics, width, height) {
      // Sol de base
...

  {
    ...
    targetTime: 60,
    spawn: { x: 140, y: 120 },
    checkpointZone: { x: 600, y: 350, w: 120, h: 40 }, // Zone de passage orange sur le toboggan
    goal: { x: 980, y: 560, w: 140, h: 40 },
    walkDirection: 1,
    build(physics, width, height) {
      // Toboggan incliné
...

  {
    ...
    targetTime: 120,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 600, y: 520, w: 120, h: 60 }, // Zone de passage orange au milieu du parcours
    goal: { x: 1040, y: 540, w: 120, h: 60 },
    walkDirection: 1,
    build(physics, width, height) {
      // Sol de base
...

  {
    ...
    targetTime: 80,
    spawn: { x: 140, y: 560 },
    checkpointZone: { x: 600, y: 380, w: 120, h: 40 }, // Zone de passage orange au 2ème étage
...

  {
    ...
    targetTime: 70,
    spawn: { x: 120, y: 480 },
    checkpointZone: { x: 550, y: 480, w: 120, h: 60 }, // Zone de passage orange au milieu du pont de glace
    goal: { x: 1040, y: 480, w: 120, h: 60 },
    walkDirection: 1,
    build(physics, width, height) {
      // Plateformes de départ et d'arrivée
...

  {
    ...
    targetTime: 90,
    spawn: { x: 140, y: 560 },
    checkpointZone: { x: 600, y: 400, w: 120, h: 40 }, // Zone de passage orange sur la pente du volcan
    goal: { x: 600, y: 140, w: 140, h: 40 },
    walkDirection: 1,
    build(physics, width, height) {
      // Base du volcan
...

  {
    ...
    targetTime: 150,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 500, y: 300, w: 120, h: 60 }, // Zone de passage orange au centre du circuit
...

  {
    ...
    targetTime: 100,
    spawn: { x: 140, y: 560 },
    checkpointZone: { x: 600, y: 400, w: 120, h: 40 }, // Zone de passage orange sur une marche intermédiaire
    goal: { x: 600, y: 120, w: 140, h: 40 },
    walkDirection: 1,
    build(physics, width, height) {
      // Base de la pyramide
...

  {
    ...
    targetTime: 120,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 700, y: 460, w: 120, h: 40 }, // Zone de passage orange sur un rempart intermédiaire
    goal: { x: 1000, y: 160, w: 140, h: 40 },
    walkDirection: 1,
    build(physics, width, height) {
      // Remparts du château
...

  {
    ...
    targetTime: 90,
    spawn: { x: 140, y: 560 },
    checkpointZone: { x: 700, y: 300, w: 120, h: 40 }, // Zone de passage orange sur un module intermédiaire
...

  {
    ...
    targetTime: 110,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 700, y: 520, w: 120, h: 60 }, // Zone de passage orange au milieu de la forêt
    goal: { x: 1040, y: 540, w: 120, h: 60 },
    walkDirection: 1,
    build(physics, width, height) {
      // Sol de la forêt
...

  {
    ...
    targetTime: 85,
    spawn: { x: 140, y: 480 },
    checkpointZone: { x: 600, y: 500, w: 120, h: 60 }, // Zone de passage orange sur un pilier coloré
    goal: { x: 1040, y: 480, w: 120, h: 60 },
    walkDirection: 1,
    build(physics, width, height) {
      // Falaises du canyon
...

  {
    ...
    targetTime: 95,
    spawn: { x: 120, y: 480 },
    checkpointZone: { x: 700, y: 400, w: 120, h: 60 }, // Zone de passage orange sur une arche intermédiaire
...

  {
    ...
    targetTime: 70,
    spawn: { x: 140, y: 120 },
    checkpointZone: { x: 700, y: 200, w: 120, h: 60 }, // Zone de passage orange sur un rail intermédiaire
...

  {
    ...
    targetTime: 130,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 700, y: 440, w: 120, h: 40 }, // Zone de passage orange au milieu du labyrinthe glacé
    goal: { x: 1040, y: 160, w: 140, h: 40 },
    walkDirection: 1,
    build(physics, width, height) {
      // Sol glacé
...

  {
    ...
    targetTime: 160,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 600, y: 300, w: 120, h: 60 }, // Zone de passage orange au milieu du circuit
    goal: { x: 120, y: 540, w: 120, h: 60 },
    walkDirection: 1,
    build(physics, width, height) {
...

  {
    ...
    targetTime: 95,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 700, y: 500, w: 120, h: 60 }, // Zone de passage orange au milieu de la grotte
    goal: { x: 1040, y: 540, w: 120, h: 60 },
    walkDirection: 1,
    build(physics, width, height) {
      // Sol de la grotte
...

  {
    ...
    targetTime: 80,
    spawn: { x: 140, y: 560 },
    checkpointZone: { x: 500, y: 380, w: 120, h: 40 }, // Zone de passage orange sur une bulle intermédiaire
    goal: { x: 600, y: 120, w: 140, h: 40 },
    walkDirection: 1,
    build(physics, width, height) {
      // Bulles flottantes
...

  {
    ...
    targetTime: 140,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 700, y: 480, w: 120, h: 60 }, // Zone de passage orange au milieu du parc
    goal: { x: 1040, y: 540, w: 120, h: 60 },
    walkDirection: 1,
    build(physics, width, height) {
      // Sol du parc
...

  {
    ...
    targetTime: 125,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 700, y: 420, w: 120, h: 40 }, // Zone de passage orange sur un gratte-ciel intermédiaire
    goal: { x: 1040, y: 160, w: 140, h: 40 },
    walkDirection: 1,
    build(physics, width, height) {
      // Gratte-ciels
...

  {
    ...
    targetTime: 115,
    spawn: { x: 140, y: 560 },
    checkpointZone: { x: 600, y: 400, w: 120, h: 40 }, // Zone de passage orange sur une île intermédiaire
...

  {
    ...
    targetTime: 100,
    spawn: { x: 140, y: 120 },
    checkpointZone: { x: 700, y: 360, w: 120, h: 40 }, // Zone de passage orange dans une galerie intermédiaire
    goal: { x: 980, y: 560, w: 140, h: 40 },
    walkDirection: 1,
    build(physics, width, height) {
      // Galeries de la mine
...

  {
    ...
    targetTime: 135,
    spawn: { x: 120, y: 540 },
    checkpointZone: { x: 550, y: 450, w: 120, h: 60 }, // Zone de passage orange au milieu du circuit
    goal: { x: 120, y: 540, w: 120, h: 60 },
    walkDirection: 1,
    build(physics, width, height) {
